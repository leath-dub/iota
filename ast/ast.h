...
typedef struct Expr {
	...
	Expr_Kind t;
	union {
		struct { Tok op; struct Expr *operand; } unary;
		struct { Tok op; struct Expr *left; struct Expr *right; } binary;
		Tok literal;
		// TODO: add postfix expressions like array access and slicing + function calls
	};
} Expr;
