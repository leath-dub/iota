...
#define DUMP(d, c, node, name) \
  dump_node(d, c, node, #name, (Dumper)dump_##name);

// For debug and testing purposes
// void dump_mod(Dump_Out *dmp, Parse_Context *c, Module *m);
// void dump_decl(Dump_Out *dmp, Parse_Context *c, Declaration *d);
// void dump_var_decl(Dump_Out *dmp, Parse_Context *c, Variable_Declaration
// *vd); void dump_type(Dump_Out *dmp, Parse_Context *c, Type *t); void
// dump_fun_decl(Dump_Out *dmp, Parse_Context *c, Function_Declaration *fd);
